export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenNodus-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenNodus-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
