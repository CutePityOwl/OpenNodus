export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenNodus",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenNodus wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
