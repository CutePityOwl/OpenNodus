export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenNodus",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenNodus. Czy chcesz ją zainstalować i uruchomić ponownie?",
