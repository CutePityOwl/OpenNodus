export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenNodus",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenNodus a été téléchargée. Voulez-vous l'installer et redémarrer ?",
