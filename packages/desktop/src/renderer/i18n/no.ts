export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenNodus",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenNodus er lastet ned. Vil du installere den og starte på nytt?",
