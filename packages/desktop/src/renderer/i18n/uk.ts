export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію OpenNodus",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} OpenNodus завантажено. Бажаєте встановити її та перезапустити?",
