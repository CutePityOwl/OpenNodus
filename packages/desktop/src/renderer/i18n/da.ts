export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenNodus",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenNodus er blevet downloadet. Vil du installere den og genstarte?",
