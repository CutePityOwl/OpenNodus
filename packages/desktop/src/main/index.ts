...
const APP_IDS: Record<string, string> = {
  dev: "ai.opennodus.desktop.dev",
  beta: "ai.opennodus.desktop.beta",
  prod: "ai.opennodus.desktop",
}
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "ai.opennodus.desktop.dev"
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "OpenNodus Dev")
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("opennodus://"))
    if (urls.length) {
  ...
  app.setAsDefaultProtocolClient("opennodus")
  registerRendererProtocol()
  setDockIcon()
  setupAutoUpdater()
