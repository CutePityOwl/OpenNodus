export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenNodus.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenNodus.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenNodus.",
  ...
  "dialog.server.description": "Switch which OpenNodus server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenNodus ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenNodus project",
  ...
  "sidebar.gettingStarted.line1": "OpenNodus includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OpenNodus Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for OpenNodus",
  ...
  "settings.general.row.appearance.description": "Customise how OpenNodus looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenNodus follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenNodus is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenNodus launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenNodus.",
